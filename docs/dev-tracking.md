...
| **Observability** | Phase 6 — Loki+Grafana log viewer (docker mode, ✅) · Jaeger tracing, Prometheus/Grafana metrics, structured logs w/ correlation ID (after gRPC Charge) | 🟡 | ⬜ |
